...
use crate::command_line::{
    CommandHistory, CommandSubmitted, DebugVisualizationState, handle_text_submission,
    navigate_command_history, parse_commandline_input, spawn_text_input,
};
...
fn main() {
    App::new()
        ...
        .add_systems(
            Update,
            (
                (handle_text_submission, parse_commandline_input).chain(),
