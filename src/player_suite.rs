...
impl PlayerSuiteResource {
    ...
    pub(crate) fn shield(&self) -> u16 {
        self.shield
    }

    pub(crate) fn points(&self) -> u16 {
        self.points
    }

    pub(crate) fn money(&self) -> u16 {
        self.money
    }

    pub(crate) fn add_health(&mut self, health: u16) {
        self.health += health;
    }

    pub(crate) fn subtract_health(&mut self, health: i16) -> ReturnStatus {
    ...
    pub(crate) fn add_shield(&mut self, shield: u16) {
        self.shield += shield;
    }

    pub(crate) fn subtract_shield(&mut self, shield: i16) -> ReturnStatus {
    ...
    pub(crate) fn add_points(&mut self, points: u16) {
        self.points += points;
    }

    pub(crate) fn subtract_points(&mut self, points: i16) -> ReturnStatus {
    ...
    pub(crate) fn add_money(&mut self, money: u16) {
        self.money += money;
    }

    pub(crate) fn subtract_money(&mut self, money: i16) -> ReturnStatus {
    ...
    pub(crate) fn perform_transaction(&mut self, price: u16) -> TransactionReturnStatus {
        if self.money >= price {
            self.money -= price;
...
pub(crate) fn player_died_observer(_trigger: On<PlayerHasDied>) {
